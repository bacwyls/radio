...
export const Viewers: FC<IViewers> = (props: IViewers) => {
    ...
    return (
        ...
        >
            ...
            </div>
            {
                ...
                <div className='absolute flex border flex-wrap flex-col rounded 
                           p-1 justify-between overflow-y-hidden overflow-x-auto
                           w-4/5'
